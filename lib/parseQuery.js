...
function parseQuery(initialState, location) {
  ...
  return Object.keys(pathConfig).reduce(function (prev, curr) {
    ...
    var stateKey = _pathConfig$curr.stateKey;
    var _pathConfig$curr$opti = _pathConfig$curr.options;
    var options = _pathConfig$curr$opti === undefined ? {} : _pathConfig$curr$opti;
    var initialValue = _pathConfig$curr.initialState;
    var type = _pathConfig$curr.type;

    var paramValue = location.query[curr];
